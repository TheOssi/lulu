...
public class NewConnectionManager {
	...
	private static final NewConnectionManager INSTANCE = new NewConnectionManager();
	...
	public static synchronized NewConnectionManager getInstance() throws IOException, SQLException, PropertyVetoException {
		return INSTANCE;
	}
