...
public class WrongHashException extends Exception {
	 ...
	 */
	public WrongHashException(final String message) {
		super(message);
	}
	 ...
	 */
	public WrongHashException(final Throwable cause) {
		super(cause);
	}
	 ...
	 */
	public WrongHashException(final String message, final Throwable cause) {
		super(message, cause);
	}
}