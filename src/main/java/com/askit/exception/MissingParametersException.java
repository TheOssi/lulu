...
/**
 * This exception is thrown if a parameter in face is missing.
 * 
 * @author Max Lenk
 * @version 1.0.0.0
 * @since 1.0.0.0
...
public class MissingParametersException extends Exception {
	 ...
	 */
	public MissingParametersException(final String message) {
		super(message);
	}
	 ...
	 */
	public MissingParametersException(final Throwable cause) {
		super(cause);
	}
	 ...
	 */
	public MissingParametersException(final String message, final Throwable cause) {
		super(message, cause);
	}
}